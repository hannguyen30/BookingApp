...
public class BookingOnactiFragment extends Fragment {
    ...
    private void initializeViews(View view) {
        ...
        if (Objects.equals(userRole, "own")) {
            ...
            setOnItemClickListener(lvwConfirmHotel, project.example.app.owner.BookingDetailActivity.class);
        } else if (Objects.equals(userRole, "guest")) {
            loadBookedHotelsForGuest(userId);
            setOnItemClickListener(lvwConfirmHotel, project.example.app.customer.BookingDetailActivity.class);
        }
    }
