package project.example.app.authen;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGoToMain.setOnClickListener(v -> {
            Class<?> destinationClass = "own".equals(userRole) ? project.example.app.owner.HomeActivity.class : project.example.app.customer.HomeActivity.class;
